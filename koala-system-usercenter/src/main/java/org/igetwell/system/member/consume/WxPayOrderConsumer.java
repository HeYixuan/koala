...
public class WxPayOrderConsumer implements RocketMQListener<SkillOrderMsgProtocol> {

    private static final Logger LOGGER = LoggerFactory.getLogger(WxPayOrderConsumer.class);
