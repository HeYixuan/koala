...
CREATE TABLE `sys_user` (
  `id` bigint(64) NOT NULL COMMENT '主键',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '000000' COMMENT '租户ID',
  `username` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '账号',
  `password` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '密码',
  `email` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '邮箱',
  `mobile` varchar(45) COLLATE utf8mb4_general_ci NOT NULL COMMENT '手机',
