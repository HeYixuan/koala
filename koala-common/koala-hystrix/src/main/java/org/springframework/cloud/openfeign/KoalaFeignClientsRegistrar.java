 ...
 */
@NoArgsConstructor
public class KoalaFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private Class<?> getSpringFactoriesLoaderFactoryClass() {
        return KoalaFeignAutoConfiguration.class;
    }
