...
public class JsTicketUtils {
     ...
     * @return sign
     */
    public static String createConfigSignature(String nonceStr,String jsApiTicket,String timestamp,String url){
        Map<String, String> map = new HashMap<String, String>();
        map.put("noncestr", nonceStr);
        map.put("jsapi_ticket", jsApiTicket);
        map.put("timestamp", timestamp);
        map.put("url", url);
        return SignUtils.createJsTicketSign(map);
    }
     ...
     * @return 配置JSON数据
     */
    public static String createConfigJson(String jsApiTicket, boolean debug, String appId, String url,String... jsApiList){
        long timestamp = System.currentTimeMillis()/1000;
        String nonceStr = UUID.randomUUID().toString();
        String signature = createConfigSignature(nonceStr, jsApiTicket, timestamp + "", url);
