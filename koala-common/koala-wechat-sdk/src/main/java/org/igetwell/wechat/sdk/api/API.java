...
public class API extends BaseAPI {
    ...
    public interface APIHandler {
        ...
        String accessToken(String component_appid, String authorizer_appid);

        String accessToken(String appid);

        String componentAccessToken(String component_appid);

        String ticket(String component_appid, String authorizer_appid, String type);

        String ticket(String appid, String type);
    }
