...
import org.igetwell.oauth.security.KoalaClientDetailsService;
import org.igetwell.oauth.security.KoalaUser;
import org.igetwell.oauth.security.SpringSecurityService;
import org.igetwell.oauth.security.converter.KoalaUserAuthenticationConverter;
...
public class AuthorizationServer extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints){
        endpoints
                ...
                .pathMapping("/oauth/confirm_access", "/oauth/confirm_access") // 自定义确认授权页面
